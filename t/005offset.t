...
my $offpolys1 = Math::Clipper::offset([$ccw], 1.0);
...
my $offpolys2 = Math::Clipper::offset([$offpolys1->[0] , $cw], 1.0); # $cw works as a hole inside $offpolys1->[0]
...
my $offpolys3 = Math::Clipper::offset([$ccw],-1.0);
...
my $offpolys4 = Math::Clipper::offset([$offpolys2->[0],$offpolys2->[1]],-1.0);
